...
(function ($) {
    $.fn.htmlbox = function (options) {
        ...
        var d = {
            ...
            idir: "/public//vendor/jquery-html-box-editor/images/", // HtmlBox Image Directory, This is needed for the images to work
        ...
        var toolbar = function () {
            ...
            for (var k = 0; k < d.toolbars.length; k++) {
                ...
                for (var i = 0; i < (toolbar.length); i++) {
                    ...
                    // Commands
                    var cmds = {"about": "Sobre", "bold": "Negrito", "center": "Centralizar", "code": "View Code", "copy": "Copy", "cut": "Cut", "hr": "Inserir linha", "link": "Inserir link", "image": "Inserur imagem", "indent": "Indent", "italic": "Itálico", "justify": "Justificar", "left": "Alinhar à esquerda", "ol": "Lista ordenada", "outdent": "Remover citação", "paragraph": "Insert Paragraph", "paste": "Paste", "quote": "Citação", "redo": "Refazer", "removeformat": "Remove Format", "right": "Alinhar à direita", "strike": "Strikethrough", "striptags": "Strip Tags", "sub": "Subscript", "sup": "Superscript", "ul": "Lista comum", "underline": "Sublinhado", "undo": "Desfazer", "unlink": "Remover link"};
        ...
        this._init = function (is_init) {
            ...
            try {
                ...
                if (bowser.mozilla || bowser.safari) {
                    //if(text===""){text="&nbsp;";}
        ...
        this.cmd = function (cmd, arg1) {
            //ALTERADO PARA OS PENSADORES.COM - INICIO
            if(cmd==='quote'){cmd='indent'}
